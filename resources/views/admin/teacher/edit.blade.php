                ...
                <div class="card-body">
                    ...
                    <form action="{{route('update-teacher',['id'=>$teacher->id])}}" method="POST">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="mobile" value="{{$teacher->mobile}}"class="form-control" id="horizontal-email-input">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-email-input" class="col-sm-3 col-form-label">Address</label>
                            <div class="col-sm-9">
                                <input type="text" name="address" value="{{$teacher->address}}"class="form-control" id="horizontal-email-input">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label for="horizontal-email-input" class="col-sm-3 col-form-label">Image</label>
                            <div class="col-sm-9">
                                <input type="file" name="image" class="form-control" id="horizontal-email-input" accept="image/*">
                                <img src="{{asset($teacher->image)}}" height="50" width="50" style="border-radius: 50%" alt="" />
                            </div>
                        </div>
                        <div class="form-group row mb-4">
